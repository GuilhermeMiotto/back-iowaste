"""
Django settings for IoWaste project.
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='iowaste_db'),
        'USER': config('DB_USER', default='iowaste'),
        'PASSWORD': config('DB_PASSWORD', default='iowaste123'),
